...
terrData$Territory[3] <- "Virgin Islands"
...
pie <- ggplot(funcAS, aes(x="", y=Percent, fill=Category))+
  geom_bar(width = 1, stat = "identity")+
  coord_polar("y", start=0)+
  scale_fill_manual(values=c("#900C3F","#C70039", "#D4442D", "#FFF7B3","#00869F", "#6171AF","#DCB6D0","#C799C8","#D2D2D2","#585757")) +
...
pie <- ggplot(funcGU, aes(x="", y=Percent, fill=Category))+
  geom_bar(width = 1, stat = "identity")+
  coord_polar("y", start=0)+
  scale_fill_manual(values=c("#900C3F","#C70039", "#D4442D", "#00869F", "#6171AF","#DCB6D0","#C799C8","#D2D2D2","#585757","#000000")) +
...
pie <- ggplot(funcMP, aes(x="", y=Percent, fill=Category))+
  geom_bar(width = 1, stat = "identity")+
  coord_polar("y", start=0)+
  scale_fill_manual(values=c("#FFA07A","#900C3F","#C70039", "#D4442D", "#00869F", "#6171AF","#DCB6D0","#C799C8","#585757")) +
...
SEOdata$Recipient[5] <- "Departamento De Desarrollo Economico Y Comercio (Puerto Rico)"
